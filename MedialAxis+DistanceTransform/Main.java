...
static PrintWriter skeletonFile; static PrintWriter decompressFile;
public static void main(String args[]){ 
try{

inFile = new Scanner(new FileReader(args[0]));
//inFile = new Scanner(new FileReader("DistLocalMaximaDeCompress_image1.txt")); //outFile1 = new PrintWriter(new FileOutputStream("OutFile1") );
...
inFile.close();
outFile1.close();
outFile2.close(); //skeletonFile.close(); decompressFile.close(); }catch(FileNotFoundException e){
e.printStackTrace(); }
